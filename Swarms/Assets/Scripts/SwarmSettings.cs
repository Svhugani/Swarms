...
public class SwarmSettings : ScriptableObject
{
    ...
    [field: SerializeField, Range(-5f, 5f)] public float FlockingImpact { get; private set; } = 1f;
    [field: SerializeField, Range(-5f, 5f)] public float AlighImpact { get; private set; } = 1f;
    [field: SerializeField, Range(-5f, 5f)] public float CollisionImpact { get; private set; } = 1f;
    [field: SerializeField, Range(-5f, 5f)] public float TargetImpact { get; private set; } = 1f;
    [field: SerializeField, Range(-5f, 5f)] public float ObstacleImpact { get; private set; } = 1f;
    ...
    [field: SerializeField] public float TargetRange { get; private set; } = 5f;
